...
class SueWardViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        myWebView.loadHTMLString("<iframe width=\"\(myWebView.frame.width)\" height=\"\(myWebView.frame.height)\" src=\"https://www.youtube.com/embed/O9NCZkgTTEY\" frameborder=\"0\" allowfullscreen></iframe>", baseURL: nil)
    }
